...
/*STATS
Runtime: 52 ms, faster than 74.26% of JavaScript online submissions for Nim Game.
...
/*Explanation
Solution You can always win a Nim game if the number of stones nn in the pile
is not divisible by 44.
...
n=4,8,12,16,\dotsn=4,8,12,16,…, basically all multiples of 44.

Java

public boolean canWinNim(int n) { return (n % 4 != 0); } Complexity Analysis

Time complexity is O(1)O(1), since only one check is performed. No additional
space is used, so space complexity is also O(1)O(1).*/
